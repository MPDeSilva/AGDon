...
export function Hero() {
  ...
  return (
    <section
      className="relative py-20 px-4 sm:py-28"
    ...
    >
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            ...
            <a
              ...
              style={{
                ...
                border: '2px solid var(--vg-hero-ink)',
                borderRadius: 'var(--vg-radius-btn)',
              }}
            >
              {t('cta2')}
      ...
      <div
        aria-hidden="true"
        className="absolute right-0 top-0 bottom-0 w-1/3 hidden lg:block pointer-events-none"
        style={{
          background:
