...
export const themes: Record<ThemeKey, { name: string; tokens: ThemeTokens }> = {
  ...
  'sky-blue': {
    name: 'Sky Blue — Professional Trust',
    tokens: {
      '--vg-bg': '#EAF3FC',
      '--vg-surface': '#FFFFFF',
      '--vg-surface-2': '#D8EAFF',
  ...
  sunburst: {
    name: 'Sunburst — Creative Rainbow',
    tokens: {
      '--vg-bg': '#FFF7ED',
      '--vg-surface': '#FFFFFF',
      '--vg-surface-2': '#FFCF56',
  ...
  'mint-blush': {
    name: 'Mint & Blush — Soft Professional',
    tokens: {
      '--vg-bg': '#F7FBF9',
      '--vg-surface': '#FFFFFF',
      '--vg-surface-2': '#DCF2E9',
